...
На [@fig:pressure; @fig:alpha] представлены значения полей давления и объемной доли частиц в момент времени 
0,2&nbsp;мс. На рисунках видно, что по мере распространения ударной волны образуется зона компактирования частиц.
