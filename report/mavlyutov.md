...
термодинамических пареметров решения с результатами, представленными в статье
[@chuprov_mfs].
...
Здесь $\alpha_k$, $\rho_k$, $\mathbold{u}_k$, $P_k$, $E_k$ --- объемная доля, плотность, скорость, статическое давление и полная энергия. 
